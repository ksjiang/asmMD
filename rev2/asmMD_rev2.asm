...
LJforceEval13:
	mov edi, eax
	mov ecx, dword ptr [edi + 4]		;ecx -> particle j
	mov edx, dword ptr [ebp - 58h]		;edx index of* particle i
	cmp ecx, edx
...
LJenergyEval12:
	...
	add ebx, dword ptr [ebp - 74h]
	mov esi, dword ptr [ebp - 54h]
	lea edi, dword ptr [esi + 4 * ebx]	;traverse the singly-linked list
	jmp LJenergyEval14
LJenergyEval13:
	mov edi, eax
	mov ecx, dword ptr [edi + 4]		;ecx -> particle j
...
pbc3d proc nPart:DWORD, X_:DWORD, BOX:DWORD, L:DWORD
	...
	; and clear the #I mask to throw exception on invalid conversions
	mov dword ptr [ebp - 3ch], 3f00h
	ldmxcsr dword ptr [ebp - 3ch]

	mov eax, dword ptr [LJisset]
	test eax, eax
